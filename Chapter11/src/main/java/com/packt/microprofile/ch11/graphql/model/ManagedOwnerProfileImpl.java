...
public class ManagedOwnerProfileImpl extends OwnerProfileImpl implements OwnerProfile {

    private String managerName;
    private String managerEmailAddress;

    public ManagedOwnerProfileImpl() {
        super();
    }

    public ManagedOwnerProfileImpl(String ownerId, String ownerEmail, String managerName, String managerEmail) {
        super(ownerId, ownerEmail);
